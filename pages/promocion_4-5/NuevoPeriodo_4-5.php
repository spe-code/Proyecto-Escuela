...
<head>
    ...
    <title>Promoción de Estudiantes - 4to a 5to Año</title>
...
<div class="container mt-5">
    <h1 class="text-center mb-4">Promoción de Estudiantes - 4to a 5to Año</h1>
...
$(document).ready(function() {
    ...
    $('#promoverSeleccionados').click(function(e) {
        ...
        Swal.fire({
            title: '¿Está seguro?',
            text: `Está a punto de promover ${seleccionados} estudiante(s) a 5to año. ¿Desea continuar?`,
            icon: 'warning',
