...
<head>
    ...
    <title>Consultar Datos de Estudiantes de 3ro Año</title>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-consultar').on('click', function() {
                ...
                $.ajax({
                    url: '../3ro/Controladores/obtener_detalles.php', // Archivo PHP que obtiene los detalles
                    type: 'GET',
                    data: { id: id },
            ...
            $('.btn-editar').on('click', function() {
                ...
                $.ajax({
                    url: '../3ro/Controladores/obtener_datos_editar.php', // Archivo PHP que obtiene los datos para editar
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
            ...
            $('#btnActualizar').on('click', function() {
                ...
                $.ajax({
    url: '../3ro/Controladores/actualizar_datos.php', // Archivo PHP que procesa la actualización
    type: 'POST',
        ...
        $('.btn-eliminar').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '../3ro/Controladores/eliminar_estudiante.php', // Archivo PHP que elimina el estudiante
                        type: 'GET',
                        data: { id: id },
                        success: function(response) {
