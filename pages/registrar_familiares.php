...
<nav class="navbar navbar-expand-lg navbar-light navbar-custom">
                ...
                <div class="form-container">
                    ...
                    <form id="formRepresentante">
                        ...
                        <div class="row">
                            ...
                            <!-- Fila 3 -->
                            <div class="col-md-6 form-floating mb-4">
                                <input type="text" class="form-control" id="carnet_patria" name="carnet_patria" placeholder="Carnet de la Patria">
    ...
    document.querySelectorAll('#nombre_madre, #apellido_madre, #oficio_madre, #nombre_padre, #apellido_padre, #oficio_padre, #nombre_representate, #apellido_representate, #carnet_patria').forEach(input => {
        input.addEventListener('input', function (e) {
        ...
        function guardarTodos() {
            // Obtener los datos de los tres formularios
            ...
            $.ajax({
                url: 'guardar_todos.php', // Archivo PHP que procesará los datos
                type: 'POST',
                data: datosMadre + '&' + datosPadre + '&' + datosRepresentante,
                success: function(response) {
                    $('#mensaje').html(response).show();


                     // Mostrar el botón "Registrar nuevo estudiante"
                     document.getElementById('botonRegistrarNuevoEstudiante').style.display = 'block';
                },

                error: function(xhr, status, error) {
                    $('#mensaje').html('<div class="alert alert-danger">Error al guardar los datos.</div>').show();
                }
            });
        }
    </script>
