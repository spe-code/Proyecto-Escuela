...
<head>
    ...
    <title>Promoción de Estudiantes - 2do a 3ro Año</title>
...
<div class="container mt-5">
    <h1 class="text-center mb-4">Promoción de Estudiantes - 2do a 3ro Año</h1>
...
$(document).ready(function() {
    ...
    $('#promoverSeleccionados').click(function(e) {
        ...
        Swal.fire({
            title: '¿Está seguro?',
            text: `Está a punto de promover ${seleccionados} estudiante(s) a 3ro año. ¿Desea continuar?`,
            icon: 'warning',
