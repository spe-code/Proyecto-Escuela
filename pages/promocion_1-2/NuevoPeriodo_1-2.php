...
<head>
    ...
    <title>Promoción de Estudiantes - 1ro a 2do Año</title>
...
<div class="container mt-5">
    <h1 class="text-center mb-4">Promoción de Estudiantes - 1ro a 2do Año</h1>
        ...
        <table class="table">
            ...
            <tbody id="tablaEstudiantes">
                <?php if (count($rows) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="9" class="text-center">No hay estudiantes de primer año disponibles para promoción en el período <?= $periodoActual ?>.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </form>
...
$(document).ready(function() {
    ...
    $('#promoverSeleccionados').click(function(e) {
        ...
        Swal.fire({
            title: '¿Está seguro?',
            text: `Está a punto de promover ${seleccionados} estudiante(s) a 2do año. ¿Desea continuar?`,
            icon: 'warning',
