...
<head>
    ...
    <title>Consultar Datos de Estudiantes de 5to Año</title>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../5to/consultar_estudiantes_5to.php">5to AÑO</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<div class="container mt-5">
    <h1 class="text-center mb-4">Consultar Datos de Estudiantes de 5to Año</h1>
